...
import css from "../CadastroDoador1/CadastroDoador1.module.css"; // Mantém o CSS original
...
export default function EditarDoador({ api }) {
    ...
    useEffect(() => {
        ...
        // Permite ADM (tipo 0) ou o próprio doador (tipo 1)
                ...
                <div className={css.linha}>
                    <div className={css.campos}>
                        ...
                        <Input
                            ...
                            type={'text'}
                            input={email}
                            alterarInput={(e) => setEmail(e.target.value.replace(/\s/g, ''))}
                            required={true}
                        />
                    </div>
